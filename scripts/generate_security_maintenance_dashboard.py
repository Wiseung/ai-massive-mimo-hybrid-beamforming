...
def main() -> None:
    ...
    manual_audit = _load("outputs/maintenance/manual_pip_audit.json")
    ...
    if manual_audit:
        dependency_audit_status = manual_audit.get("audit_status", "not_run")
        warnings.extend(manual_audit.get("warnings", []))
        blockers.extend(manual_audit.get("blockers", []))
        recommended_next_action = manual_audit.get("recommended_next_action", "no_action")
    elif dep_audit and dep_audit.get("pip_audit_available") is False:
    ...
    payload = {
        ...
        "dependency_audit_status": dependency_audit_status,
        ...
        "blockers": blockers,
        "warnings": warnings,
        "recommended_next_action": "investigate_blocker" if blockers else (recommended_next_action if warnings or manual_audit else "no_action"),
    }
