...
def main() -> None:
    ...
    for method, method_type in methods:
        ...
        if method_type == "analytic":
            precoder = compute_project_precoder_per_subcarrier(method.removeprefix("project_"), h_f, context.noise_var)
        else:
            ...
            precoder, infer_meta, runtime_ms = infer_learned_precoder(bundle, h_f, snr_tensor, native_receiver_path=True)
